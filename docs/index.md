...
* Select*CANSIM via CHASS* under the *statistics* list.
    ...
    ![The Statistics results, with CANSIM via CHASS highlighted ]({{ '/assets/images/CANSIM_2.png' | relative_url }})
* Select *CANSIM Database* next to *Download Data.*

    ![CANSIM Database highlighted under the Download data heading]({{ '/assets/images/CANSIM_3.png' | relative_url }})
* Choose *CANSIM Multidimensional View*

    ![CANSIM Multidimensional View highlighted on the CANSIM webpage ]({{ '/assets/images/CANSIM_4.png' | relative_url }})
* Continue in your preferred language
* Choose*CANSIM**Multidimensional @ CHASS Main Menu*

    ![CANSIM Multidimensional @ CHASS Main Menu option highlighted ]({{ '/assets/images/CANSIM_5.png' | relative_url }})
...
![]({{ '/assets/images/browse%20by%20subject.png' | relative_url }})

 

2\. Expand "Prices and price indexes" and click "Consumer price indexes."

![]({{ '/assets/images/consumer%20price%20indexes.png' | relative_url }})
...
![]({{ '/assets/images/176-0003.png' | relative_url }})
...
![]({{ '/assets/images/CPI.png' | relative_url }})
...
![]({{ '/assets/images/add%20to%20series%20cart.png' | relative_url }})
...
![]({{ '/assets/images/retrieve%20series.png' | relative_url }})
...
Technique: [Searching for maps and data](/technique/searching-maps-and-data) \| Tools: [CHASS Census Analyzer](/taxonomy/term/72)**Date Created:** 2018\-01\-26**Updated:** 2022\-12\-15
